  ...
  return (
    <div>
      ...
      <div className="mx-5">
        ...
        <div className="flex flex-col gap-3 text-justify mt-5 mb-7">
          <p>
            ...
            from Educational Technology Department with a passion for technology
            and education{" "}
          </p>
          <p>
          ...
          <p>
            We have come together to build this platform with the aim of making
            it easier for students and researchers to access quality
            undergraduate projects.
          </p>
          <p>
