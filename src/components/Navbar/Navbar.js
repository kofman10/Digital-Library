    ...
    <nav className="bg-white lg:p-0 p-4 border-b-2 z-40 fixed w-full font-fraunces border-b-sky-500">
      <div className="flex items-center font-medium justify-around">
        <div className="z-50 md:w-auto w-full h-full items-center flex justify-between">
          <Link href= '/'> 
          <p className="font-bold font-dancing text-indigo-900 text-3xl">EDUTECH</p>
          <p className="top-10 font-semibold text-sm text-indigo-900 left-5 tracking-widest absolute">cloud storage</p>
          </Link>
